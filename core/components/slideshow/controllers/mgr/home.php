 ...
 */
$modx->regClientStartupScript($slideshow->config['jsUrl'].'mgr/widgets/items.grid.js');
$modx->regClientStartupScript($slideshow->config['jsUrl'].'mgr/widgets/home.panel.js');
$modx->regClientStartupScript($slideshow->config['jsUrl'].'mgr/sections/home.js');
$output = '<div id="slideshow-panel-home-div"></div>';
